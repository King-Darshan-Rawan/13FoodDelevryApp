          ...
          <div className="carousel-inner" id="carousel">
              ...
              <div className="container-fluid">
                <div className="d-flex justify-content-center">
                  <input
                    ...
                    aria-label="Search"
                  />
                  {/* <button className="btn text-info bg-dark btn-outline-success " type="prevent"> */}
                  {/* Search */}
                  {/* </button> */}
                </div>
              </div>
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-caption d-none d-md-block mb-8 fw-bold fw-italic">
                ...
                <p>
                  A sandwich is a dish typically consisting of vegetables,
                  sliced cheese or meat, placed on or between slices of bread
                </p>
              </div>
            </div>
          </div>
                    ...
                    {items !== null ? (
                      items
                        ...
                        .map((filteredItem) => (
                          ...
                          >
                            <Cards filteredItem={filteredItem} foodOption={filteredItem.options[0]} />
